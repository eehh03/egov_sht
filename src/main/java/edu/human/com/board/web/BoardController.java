...
public class BoardController {
    ...
    /*
     * AdminLTE용 답글 작성폼 내용을 DB에 입력 200907
     */
    ...
    /*
     *AdminLTE용 게시물 작성 실제 DB에 입력처리 200904
     */
	...
	/*
	 * AdminLTE용 게시물 작성폼 화면으로 이동 200904
	 */
    ...
    public String deleteBoard(
    	...
    	LoginVO user = (LoginVO)EgovUserDetailsHelper.getAuthenticatedUser();
   	    ...
   	    //여기까지 진행되면, 기존 삭제 로직은 마무리, 그대로 유지(여기에 파일 삭제 기능까지 있음)
   	    //이후에 개발자가 완전삭제 코드를 추가하면 된다(아래-레코드 삭제목적)
